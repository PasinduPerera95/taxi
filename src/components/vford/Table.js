...
var b;
   Object.keys(vehiclefordriversObjects).map((id) => {
              // a=  vehiclefordriversObjects[id].driverid
             //  b=  vehiclefordriversObjects[id].vehicleid
               console.log(a);
                       approvedRows.push({
                      DID:vehiclefordriversObjects[id].driverid,
                      VID:vehiclefordriversObjects[id].vehicleid
                    })
